...
| **`74ee1695…` vignette cap 0–0.04 (`sha256:74ee1695…07c15d6c`) — lab recycled** | CI `34698649413` (`#122` / `tier1`) pushed `:lab`. Lab Studio `/api/health` `lab_fast_pin=pinned` `v2_patch=200`. **Lab only. Live stays `c497505`.** Generate a **new** pack; `6e8dfa80fba8` still has 0.02–0.12 vig. | — |
