...
| **`3caeb44` voice-safe audio (`sha256:e5173d9a…`) NEW pack `37f1a5ee9234`** | Lab Fast 2, escalate on, copyid record. NEW-0409 **44/43** medium look fail/ok; NEW-1277 **29/30** look ok/ok; NEW-bradnded **31/32** look fail/fail (MAE 119, overlays still intact). Pitch 0, loudnorm off, one speed. Audio head still `error`. Stay `record`. **Do not PATCH live.** | VMAF 94 / 99.8 / 91–100. |
