...
| **`4540720` AQMTp uniqueness shade — lab only, not live** | AQMTp Fast 8 (`lab8_aqmtp454_68054751`): **8/8 strong 33–34 bits**, VMAF **97.0–98.9**, shade 100 / cloud 7 / dust 13 / gblur 10, **5.1 min**, all `ok`. SaveInta Fast 8 (`lab8_saveinta454_5edb1768`): **8/8 medium 24–27 bits**, VMAF **95.4–98.6**, **no shade**, no escalate, **4.5 min**. Jeff signs AQMTp look before any live pin. | — |
