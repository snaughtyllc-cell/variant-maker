...
- Image: `ghcr.io/snaughtyllc-cell/variant-fast@sha256:8067b6c144b53627672e063cc48fee0e449b22e5ec030d7f6c7fb62c4c26dd5c`
- Vignette cap **0–0.04** (can skip) + BtbN dated autobuild ffmpeg. `VF_LAB=1`. `VARIANT_MAKER_COPYID=record`
- CI `34697248914` on `tier1` (`a26abca` / `#117`) pushed `:lab`. GitHub `RUNPOD_API_KEY` empty — **recycle lab `xar25v77v3j27u` by hand** to this digest. **Do not PATCH live.**
...
| **`8067b6c1…` vignette cap 0–0.04 (`sha256:8067b6c1…c26dd5c`) — GHCR, recycle lab by hand** | CI `34697248914` on `tier1` (`#117`) pushed `:lab`. Cap is in the image. GitHub `RUNPOD_API_KEY` empty. **Recycle lab `xar25v77v3j27u` only. Do not PATCH live.** Generate a **new** pack; `6e8dfa80fba8` still has 0.02–0.12 vig. | — |
