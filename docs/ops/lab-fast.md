...
| **`7ef5853` look-safe crop pan — lab only** | **Open.** Lab Fast pinned 2026-08-28. Generate on Lab Studio. Check 25/50/75 stills for window creep; captions + face stay. Do not pin live until **Signed**. | — |
