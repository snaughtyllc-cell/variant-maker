...
| Handheld crop wander on live Fast `c497505` | Jeff 2026-08-29: **ok lets build that on live.** Stacked on compete. First real Generate stills are the look check. | Raise 24. Shade. Face-zoom. Set `VF_LAB` on live. |
