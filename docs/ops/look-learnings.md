...
| **2026-09-12** | Lab Fast vignette-off `fc5a8109…` (motion 3-pack after PI/5 cap still-dark) | Compete vig **0** (skip). Rotate + per-copy 30/48/60 stay. Medium. Lab only. | — | **Jeff: its fixed.** Dark wash was ffmpeg PI/5 mapping, not a 0–0.04 miss. **Do not pin live.** Live stays `c497505` (still has compete vig). |
...
| Compete vignette 0.02–0.12 always-on | Jeff 2026-09-12: motion pack **whole clip too dark**. Cap 0–0.04 still dark (ffmpeg PI/5). Skip vig (0) on `fc5a8109…`. **Jeff: its fixed.** Lab only. Live Fast `c497505` still has compete vig — do not PATCH live without a live stills pass. | Raise 24. Shade. Restore 0.12/0.20. Pin live without stills. PATCH live. |
