...
| **2026-08-29** | Compete Fast `d0a7bc5` Gallery **LOOK-SaveInta** / **LOOK-AQMTp** / **LOOK-bring-me-down** (`166cf4bae4be`) | Lab Fast rotate + vignette + per-copy 30/48/60. Medium, escalate **off** on the Sign pack. | SaveInta **33/32**, AQMTp **20/19**, bring-me-down **45/46** | **Jeff: yea they look fine.** Look signed. **Not live.** MAE look-fail on SaveInta stills still look like source. Escalate-on AQMTp (`9ba1af34f29d`) was 18/17 under the floor — do not pin until that path still ships 19. |
...
| Compete Fast escalate-on vs 19-bit floor | Look **signed** on escalate-off `LOOK-*` (`166cf4bae4be`). Escalate-on AQMTp `9ba1af34f29d` hunted strong and still **18/17** `uniqueness_fail`. | Pin live `d0a7bc5`. Recreate `f05d803` “strong → 19 ship” by hunting uniqueness. Raise 24. |
