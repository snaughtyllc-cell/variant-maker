...
| **2026-08-31** | NEW pack `c701c9fb3594` (0409 / 1277 / bradnded) vs source | Signed medium + crop-align MAE + color stills. Fast 2. Lab `21691c4`. | **43/44**, **34/31**, **32/32** | **Jeff: yea they look good.** Agent stills not olive. Brad MAE max 3/7 (was 119 keyframe/crop). **Do not pin live yet** — separate call. 20 min wall is 3 sequential 1080 sources on **1** lab worker (65s + 63s + 22s), not CopyID. SaveInta Fast 8 in ~5 min is one short 720 × 8 in parallel. |
...
| Lab stills + CopyID audio on `c701c9fb3594` | **Jeff 2026-08-31: yea they look good.** Look MAE ok. Audio `record` scored. Live pin is a separate call. 20 min for 6 ≠ CopyID: 3 queued 1080 sources on 1 worker (65s+63s+22s). SaveInta Fast 8 ~5 min is one short 720 × 8 parallel. | `gate`. Recycle live Fast. Raise 38. Pretend 6 long 1080s match 8 short 720s on 1 CPU. |
