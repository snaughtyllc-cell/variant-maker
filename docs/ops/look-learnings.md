...
| Handheld crop wander on live Fast `c497505` | Jeff 2026-08-29: **ok lets build that on live**, then lab-verify so we know if live must come off. Lab pack `1fbe4f51de83`: SaveInta **33/33**, motion **43/45**, AQMTp **18/17** parked. Stills not lava/snow. **Live stays.** Next real Generate stills are still the look check. | Raise 24. Shade. Face-zoom. Set `VF_LAB` on live. Roll live back to `d0a7bc5` without a broken look. |>>>>>>> origin/cursor/copyid-lab-record-cdb6
