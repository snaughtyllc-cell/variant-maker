...
| Compete vignette 0.02–0.12 always-on | Jeff 2026-09-12 on the motion 3-pack: **whole clip too dark** vs source. `lookcompete4` vig **0.114** was already black-corner look-fail. Cap medium/strong to **0–0.04** (can skip). **Lab only. Live stays `c497505`.** | Raise 24. Shade. Restore 0.12/0.20. Pin live on this cap without stills. |
