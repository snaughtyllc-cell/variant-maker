...
export const ESCALATED_TITLE =
  "Medium is supposed to land around 55–65% pixel SSIM vs the original. This one missed on the first pass, so it used a stronger encode. Originality is still OK — not a fail. Pass is ~38% vs the source. After that hunt, 30% and up still ships; under 30% is a uniqueness miss. Not a platform check.";
