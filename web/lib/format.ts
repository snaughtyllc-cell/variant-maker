...
export const ESCALATED_TITLE =
  "Medium is supposed to land around 50–60% vs the original. This one missed on the first pass, so it used a stronger encode. Visual score is still OK — not a fail. Pass is ~38% vs the source, even for a single file.";
