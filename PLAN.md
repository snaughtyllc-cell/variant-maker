...
- **Separate Studio track (building):** Instagram Analytics tab (`/analytics`) —
  official Meta Connect (many tester accounts), scoreboard + Gallery compact
  views, amplify winners. Not 12c. Not a detector. Spec:
