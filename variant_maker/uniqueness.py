...
# ~35–42 bits (~55–65% UI) via moderate crop (keep 0.84–0.90) and chroma-only
# grain (SSIM All sees chroma; VMAF is mostly luma). Rebuild stays sharp — a
# mushy downscale is invisible at 576. Not ±32 px and not a face-only zoom.
